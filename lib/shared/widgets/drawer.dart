...
import 'package:palaction/screens/chat/chat_list.dart';
import 'package:palaction/screens/crud/admin/cases_adminlist.dart';

import 'package:palaction/screens/crud/admin/users_adminlist.dart';
import 'package:palaction/screens/crud/cases/cases_list.dart';
import 'package:palaction/screens/crud/cases/register_case.dart';

import 'package:palaction/screens/crud/user/profile.dart';
    ...
    return Drawer(
      child: ListView(
        ...
        children: [
          ...
          ListTile(
            title: const Text('Register Court Case'),
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
